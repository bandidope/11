...
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
  ...
  global.owner = [
    [ '222265178386528@lid', 'Xiters', true ],
  [ '', true ]
  ]
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
...
global.author = '𝗫𝗶𝘁𝗲𝗿𝘀 𝗕𝗼𝘁 🔱'
global.stickpack = '𝗫𝗶𝘁𝗲𝗿𝘀 𝗕𝗼𝘁 🔱'
global.stickauth = '𝗫𝗶𝘁𝗲𝗿𝘀 𝗕𝗼𝘁 🔱'
global.wm = '𝗫𝗶𝘁𝗲𝗿𝘀 𝗕𝗼𝘁 🔱'
global.dev = '𝐒𝐨𝐟𝐭𝐰𝐚𝐫𝐞 𝐁𝐲 𝐓𝐞𝐜𝐧𝐨𝐥𝐨𝐠𝐢𝐬 𝐠𝐫𝐮𝐩'
global.wait = '*𝐏𝐨𝐫 𝐟𝐚𝐯𝐨𝐫 𝐚𝐠𝐮𝐚𝐫𝐝𝐞 𝐮𝐧 𝐦𝐨𝐦𝐞𝐧𝐭𝐨\n\n> 𝗫𝗶𝘁𝗲𝗿𝘀 𝗕𝗼𝘁 🔱*'
global.botname = '𝗫𝗶𝘁𝗲𝗿𝘀 𝗕𝗼𝘁 🔱'
global.textbot = `𝐓𝐞𝐜𝐧𝐨𝐥𝐨𝐠𝐢𝐬 𝐛𝐲 𝐓𝐡𝐞-𝐌𝐢𝐤𝐮𝐁𝐨𝐭-𝐌𝐃`
global.dev = '𝐒𝐨𝐟𝐭𝐰𝐚𝐫𝐞 𝐁𝐲 𝐓𝐞𝐜𝐧𝐨𝐥𝐨𝐠𝐢𝐬 𝐠𝐫𝐮𝐩'
global.listo = '*𝐄𝐱𝐢𝐭𝐨*'
global.namechannel = '𝗫𝗶𝘁𝗲𝗿𝘀 𝗕𝗼𝘁 🔱'
...
global.insta = 'https://instagram.com/'
